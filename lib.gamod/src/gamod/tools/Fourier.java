...
public final class Fourier {
  ...
  private final static int N_WAVE = 1024;
  private final static int LOG2_N_WAVE = 10;
  ...
  private static short fix_mpy(int a, int b) {
    int x = a * b >> 14;
    return (short)((x & 1) + (x >> 1));
  }

  private static short[] Sinewave = {
